...
public class testMedicalrecordController {
	...
	void testGetAllMedicarecord() throws Exception {
	    ...
	    mockMvc.perform(get("/medicalrecords"))
	            ...
	            .andExpect(jsonPath("$[0].firstName").value("John")) // Vérifier le firstName du premier enregistrement
	            .andExpect(jsonPath("$[1].firstName").value("Nicolas")) // Vérifier le firstName du deuxième enregistrement
	            .andReturn();
	}
