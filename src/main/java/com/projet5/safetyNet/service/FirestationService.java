 ...
 * Elle interagit avec les repositories pour effectuer les opérations nécessaires
 * de gestion des casernes et des personnes associées.
 * </p>
 * 
...
public class FirestationService {
     ...
     * 
     * @return Une liste d'objets {@link Firestation} représentant toutes les casernes.
     * @throws RuntimeException si une erreur se produit lors de la récupération des données.
     */
     ...
     * @throws IllegalArgumentException Si les champs adresse ou station sont invalides.
     ...
     * @throws IllegalArgumentException Si les champs adresse ou station sont invalides.
     * @throws RuntimeException Si une erreur se produit lors de la suppression.
     */
     ...
     * @throws RuntimeException Si une erreur se produit lors de la mise à jour.
     */
     ...
     * <p>
     * Cette méthode filtre les stations et les personnes associées à l'adresse de la station de pompiers
     * puis retourne une liste d'informations sous forme de chaînes de caractères (prénom, nom, adresse).
     * </p>
     * 
     * @param station Le numéro de la station de pompiers.
     * @return Une liste de chaînes de caractères contenant les informations des personnes liées à la station.
     * @throws Exception Si une erreur se produit lors de la récupération des données ou du filtrage.
     */
    public List<String> personFromFirestation(String station) throws Exception {
        ...
        try {
            ...
            for (Person person : personFromFirestation) {
                String personInfo = person.getFirstName() + " " + person.getLastName() + ", " + person.getAddress()
                        + ", Station: " + station;
